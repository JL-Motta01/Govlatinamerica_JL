...
def coleta_conteudo():
    ...
    for link in coleta_link():
        ...
        url = link
        publicado_em = entrevistas.find("span", class_="documentPublished").find("span", class_="value").text.split(" ")
        try:
        ...
        try:
            ...
            lista_conteudo= "NA"
        try:
            subtitulo = entrevistas.find("a", class_="nitfSubtitle").text
        except:
            subtitulo="NA"
