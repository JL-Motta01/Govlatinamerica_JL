...
def coleta_link():
    ...
    lista_links=[]
    html = acessar_pagina("https://www.gov.br/planalto/pt-br/nova-vice-presidencia/central-de-conteudo/publicacoes/discursos")
    discursos = html.find_all("article", class_="entry")
...
def coleta_conteudo():
    ...
    db = TinyDB(f"{DIR_LOCAL}/govlatinamerica/brasil/govfederal/govbr/bd/db_discursos_vice.json",ensure_ascii=False)
    User = Query()
