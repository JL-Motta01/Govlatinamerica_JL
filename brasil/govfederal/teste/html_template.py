    ...
    with tag('html'):
        with tag('head'):
            ...
            for l in links:
                ...
                doc.asis(f'<link rel={l} type="text/css" href="C:/Users/Kayo/codigo/govlatinamerica/template/style.css">')
        ...
        with tag('body'):
            with tag('div', klass='container'):
                ...
                with tag('div', klass='referencia'):
                    ...
                    with tag('h2'):
                        #text("Como citar")
                        doc.asis('<span id="data_acesso">Acesso em : [dd] de [month.] de [AAAA]</span>')
                ...
                with tag('div', klass='aviso-texto'):
                    ...
                    for paragrafo in paragrafos_avisos:
                        with tag('p', klass='paragrafo-aviso'):
                            text(paragrafo)
            # doc.asis('<script type="text/javascript" src="/home/labri_juliasilveira/codigo/newscloud/templates-ref/referencias.js"</script>')
...
if __name__ == '__main__':
    ...
    with open(f"{DIR_FINAL}/carta-capital/html/template/{titulo}.html", "w") as file:
        file.write(result)
